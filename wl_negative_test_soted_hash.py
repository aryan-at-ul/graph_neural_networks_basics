...
g1 = Graph()
g1.add_vertices(6)
g1.add_edges([[0,1],[1,2],[2,3],[3,4],[4,1],[4,5],[5,0]])#,[7,2],[7,8],[8,9],[9,0]])


g2 = Graph()
g2.add_vertices(6)
g2.add_edges([[0,1],[1,2],[2,3],[3,4],[4,2],[1,5],[5,0]])#,[7,3],[2,8],[8,9],[9,0]])
...
G1 = g1#generateTree(20, 2)
G2 = g2#generateTree(20, 2)
